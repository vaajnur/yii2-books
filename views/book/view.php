...
<?php if ($model->cover): ?><?= Html::img(Yii::getAlias('@web/uploads/covers/') . rawurlencode($model->cover), ['style' => 'max-width:300px;max-height:420px', 'class' => 'mb-3', 'alt' => $model->title]) ?><?php endif; ?>
