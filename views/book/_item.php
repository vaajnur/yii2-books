...
<?php if ($model->cover): ?><?= Html::img(Yii::getAlias('@web/uploads/covers/') . rawurlencode($model->cover), ['class' => 'card-img-top', 'style' => 'height:300px;object-fit:cover', 'alt' => $model->title]) ?><?php endif; ?>
